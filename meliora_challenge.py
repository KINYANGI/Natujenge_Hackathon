...
mask =   0x11111111111111110000000000000000000000000000000000000000

print(source&mask)

destination = 0x1355b6767988295e00000000000300347e581e360000000000000000
mask =        0x00000000000000001111111111111111000000000000000000000000
